...
v = myLDA(meas_norm, iris_labels, NewDim,species);
...
IRIS1_rec = meas_reduced(strcmp(species,'setosa'), :);		    %Samples of Class 0
IRIS2_rec = meas_reduced(strcmp(species,'versicolor'), :); 			%Samples of Class 1
IRIS3_rec = meas_reduced(strcmp(species,'virginica'), :);			%Samples of Class 2

plot(IRIS1_rec(:, 1), IRIS1_rec(:, 2), 'bo');
plot(IRIS2_rec(:, 1), IRIS2_rec(:, 2), 'rs');
plot(IRIS3_rec(:, 1), IRIS3_rec(:, 2), 'g+');
